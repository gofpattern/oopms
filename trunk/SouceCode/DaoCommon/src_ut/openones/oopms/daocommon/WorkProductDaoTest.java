...
public class WorkProductDaoTest {
    ...
    /**
     * Test method for {@link openones.tms.dms.dao.WorkProductDao#getWorkproduct()}.
     */
    @Test
    public void testGetWorkproduct() {
        WorkProductDao wpDao = new WorkProductDao();
        // QcActivity qcAc = new QcActivity();
        ArrayList<Workproduct> qcAc = new ArrayList<Workproduct>();
        // qcAc = qcAcDao.getQcActivity("UNIT_TEST");
        qcAc = wpDao.getWorkproduct();
        assertEquals("Acceptance note", qcAc.get(0).getName());
    }
