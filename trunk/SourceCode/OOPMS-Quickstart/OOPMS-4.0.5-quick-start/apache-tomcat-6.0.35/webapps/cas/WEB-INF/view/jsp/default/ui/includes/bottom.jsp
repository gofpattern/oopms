<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
                ...
                <div id="footer" class="fl-panel fl-note fl-bevel-white fl-font-size-80">
                    ...
                    <div id="copyright">
                      <p>Customized by <a href="http://open-ones.com" target="_blank">Open-Ones</a>. All rights reserved.
                        Powered by <a href="http://www.jasig.org/cas" target="_blank">Jasig</a></p>
                    <%-- Open-Ones
