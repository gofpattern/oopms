...
public class RequirementDao {
    ...
    public boolean updateReq(Requirements req) {
        ...
        try {
            ...
            log.error("UpdateContent: " + req.getRequirementID() + ", " + req.getRequirement() + ", "
                    + req.getProjectID() + ", " + req.getReleaseNote());
            session.update(req);

            // String hql =
            // "UPDATE Requirements requirement SET requirement.project_ID =:project_ID, requirement.type =:type,"
            // +
