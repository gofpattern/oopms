...
<form:form name="${portletNamespace}CreateStage" commandName="CreateStageForm" method="post" action="${formAction}"> 
	<table class="portlet-table">
      <tr>      
        ...
        <td><input maxlength="9" name="plannedStartDate" size="9" value="" type="text" id="datepicker1"/>
          (mm/dd/yyyy)</td>
      </tr>
      <tr>
        <th scope="row">Re-planned start date</th>
        <td><input maxlength="9" name="rePlannedStartDate" size="9" value="" type="text" id="datepicker2"/>
          (mm/dd/yyyy)</td>
      </tr>
      <tr>
        <th scope="row">Actual start date</th>
        <td><input maxlength="9" name="actualStartDate" size="9" value="" type="text" id="datepicker3"/>
          (mm/dd/yyyy)</td>
      </tr>
  	  <tr>
        <th scope="row">Planned end date*</th>
        <td><input maxlength="9" name="plannedEndDate" size="9" value="" type="text" id="datepicker4"/>
          (mm/dd/yyyy)</td>
      </tr>
      <tr>
        <th scope="row">Re-planned end date</th>
        <td><input maxlength="9" name="rePlannedEndDate" size="9" value="" type="text" id="datepicker5"/>
          (mm/dd/yyyy)</td>
      </tr>
      <tr>
        <th scope="row">Actual end date</th>
        <td><input maxlength="9" name="actualEndDate" size="9" value="" type="text" id="datepicker6"/>
          (mm/dd/yyyy)</td>
      </tr>
      <tr>
