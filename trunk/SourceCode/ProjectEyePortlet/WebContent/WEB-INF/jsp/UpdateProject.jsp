...
<form:form name="${portletNamespace}UpdateProject" commandName="UpdateProjectForm" method="post" action="${formAction}" onsubmit="return yav.performCheck('${portletNamespace}UpdateProject', rules, 'inline');">
