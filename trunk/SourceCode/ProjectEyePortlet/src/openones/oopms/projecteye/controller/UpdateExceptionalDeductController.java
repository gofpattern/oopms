...
@Controller
@RequestMapping("VIEW")
public class UpdateExceptionalDeductController {

	Developer user = new Developer();
	/** Logger for logging. */
	private static Logger log = Logger
			.getLogger(UpdateExceptionalDeductController.class);
	String projectId;

	@ActionMapping(params = "action=UpdateExceptionalDeduct")
	public void processUpdateExceptionalDeduct(
			UpdateExceptionalDeductForm formBean, BindingResult result,
			SessionStatus status, ActionResponse response) {
		log.debug("process UpdateExceptionalDeduct.START");
