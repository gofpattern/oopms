...
public class DeleteCostForm {
	...
	/**
	 * @param oopmsExceptionalCostId the oopmsExceptionalCostId to set
	 */
	...
	/**
	 * @param oopmsCostOneTimeExpenseId the oopmsCostOneTimeExpenseId to set
	 */
