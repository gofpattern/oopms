...
<script type="text/javascript" src="/<spring:message code="app.context"/>/resource_files/validate.js"></script>
<script type="text/javascript" src="/<spring:message code="app.context"/>/resource_files/menu.js"></script>
<div id="dropmenudiv" style="visibility:hidden;width:230;background-color:#E6E6E6" onmouseover="clearhidemenu()" onmouseout="dynamichide(event)">
</div>

<table height="51" bgcolor="#000000" border="0" cellpadding="0" cellspacing="0" width="100%">
    <tbody><tr>
        <td height="51" background="/<spring:message code="app.context"/>/resource_files/bgr_header.gif" bgcolor="#310C52" width="212"><img src="resource_files/defect_logop1.gif" height="51" border="0" width="188"><br></td>
        <td align="left" height="51" background="/<spring:message code="app.context"/>/resource_files/bgr_header.gif" bgcolor="#310C52" valign="top" width="50%"><img src="resource_files/defect_logop2.gif" height="51" border="0" width="173"></td>
        <td align="right" height="51" background="/<spring:message code="app.context"/>/resource_files/bgr_header.gif" bgcolor="#310C52" valign="top" width="50%"><img src="resource_files/header.gif" height="51" border="0" width="384"></td>
    </tr>
    <tr>
        ...
        <table height="20" bgcolor="#310C52" border="0" cellpadding="0" cellspacing="1" width="100%">
            ...
            <tr>
                ...
                <p align="center"><font face="Verdana" size="2"> <a href="javascript:void(0)" onclick="return menuClick('mnuLogout',document.forms[0])"> <span style="color: blue; font-family: arial, helvetica; font-size: 10pt; text-decoration: none; font-weight: bold"> <b><font face="Verdana" color="#AE3800">Manage Views</font></b></span></a></font></p>
                </td>
                <td bordercolor="#310C52" align="center" height="14" bgcolor="#FFD731" valign="middle">
