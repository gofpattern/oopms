...
/
CREATE TABLE OOPMS_OOPMS_STAGE ( 
...
/
CREATE TABLE OOPMS_OOPMS_PRODUCT ( 
...
/
CREATE TABLE OOPMS_OOPMS_DELIVERABLE ( 
	ProductID        		VARCHAR2(10) NOT NULL,
...
/
COMMENT ON TABLE OOPMS_OOPMS_RISK IS 'Project risks (Insight)'
/
COMMENT ON COLUMN RISK.BASELINED IS 'defined as a common risk'
/

CREATE TABLE OOPMS_OOPMS_ISSUE ( 
...
/
COMMENT ON TABLE OOPMS_OOPMS_ISSUE IS '(Insight)'
/
