...
- Path to the uPortal-4.0.5-quick-start folder should not contain spaces.
...
-The uPortal source code is included with this distribution. A seperate
 build.xml exists in the uPortal-4.0.5 directory that provides Ant targets to
 ...
 uPortal-4.0.5 directory. Running the following command from the uPortal-4.0.5
 directory will list available uPortal Ant targets:

../ant -p

-Log messages for uPortal appear in apache-tomcat-6.0.35/portal.log. Log files for
 Tomcat appear in apache-tomcat-6.0.35/logs
...
Running svn commands in the uPortal-4.0.5 directory will work as if you checked
