...
/**
 * ProductLocActual generated by hbm2java
 */
public class ProductLocActual  implements java.io.Serializable {
    ...
    public ProductLocActual() {
    }

	
    public ProductLocActual(BigDecimal productLocId, Module module, Project project, Language language) {
        this.productLocId = productLocId;
        this.module = module;
        this.project = project;
        this.language = language;
    }
    public ProductLocActual(BigDecimal productLocId, Module module, Project project, Language language, BigDecimal locProductivity, BigDecimal locQuality, BigDecimal motherBody, BigDecimal added, BigDecimal modified, BigDecimal total, BigDecimal reused, BigDecimal generated, String note) {
       this.productLocId = productLocId;
       this.module = module;
       this.project = project;
       this.language = language;
