...
public class CreateRiskForm {
	...
	/**
	 * @param estimatedImpactTo the estimatedImpactTo to set
	 */
	...
	/**
	 * @param estimatedImpactUnit the estimatedImpactUnit to set
	 */
	...
	/**
	 * @param estimatedImpact the estimatedImpact to set
	 */
	...
	/**
	 * @param totalImpact the totalImpact to set
	 */
	...
	/**
	 * @param riskPriority the riskPriority to set
	 */
	...
	/**
	 * @param riskSource_SelectedValue the riskSource_SelectedValue to set
	 */
	...
	/**
	 * @param estimatedImpactTo_SelectedValue the estimatedImpactTo_SelectedValue to set
	 */
	...
	/**
	 * @param estimatedImpactUnit_SelectedValue the estimatedImpactUnit_SelectedValue to set
	 */
