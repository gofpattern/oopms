...
ALPHASPACE_MSG : 'Please do not use special character in {1}',
MINLENGTH_MSG : 'Please Enter {1} with at least {2} characters long.',
MAXLENGTH_MSG : 'Please Enter {1} with no more than {2} characters long.',
FIXLENGTH_MSG : 'Please Enter {1} with {2} characters long.',
NUMRANGE_MSG : '{1} must be a number in {2} range.',
DATE_MSG : '{1} is not a valid date, please using the format MM-dd-yyyy.',
...
DATE_LT_MSG : 'Please enter {1} previous to {2}.',
DATE_LE_MSG : 'Please enter {1} previous or equal to {2}.',
