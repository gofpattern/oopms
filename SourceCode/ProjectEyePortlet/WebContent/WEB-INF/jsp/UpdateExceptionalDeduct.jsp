...
function fnFeaturesInit ()
{
	...
	  });
	  $( "#datepicker1" ).datepicker({
	        ...
	        yav.init('${portletNamespace}UpdateExceptionalDeduct', rules);
            ...
            document.getElementById('description').innerHTML = "${UpdateExceptionalDeductForm.description}";
	});
...
<title>Update Exceptional Deduct</title>	
</head>
...
<div  class="container"><%@ include file="/WEB-INF/jsp/Menu.jsp" %>
  ...
  <!-- begin .navigator -->
   ...
   <div class="fl-widget-titlebar titlebar portlet-titlebar">
    	<br><p class="title" id="headerDuyND">Update Exceptional Deduct</p>
    </div>


	<portlet:actionURL var="formAction">
  		<portlet:param name="action" value="UpdateExceptionalDeduct" />
...
<form:form name="${portletNamespace}UpdateExceptionalDeduct" commandName="UpdateExceptionalDeductForm" method="post" action="${formAction}">
...
<table class="display dataTable" id="mainTable2" cellpadding="0" cellspacing="0" border="0">	
   ...
   <c:forEach var="dailyExpense" items="${DailyExpenseList}">
	...
	<button type="button" class="button blue small" onclick='submitAction2("${portletNamespace}UpdateExceptionalDeduct", "${formAction}")'>Update</button>
	<button type="reset" class="button blue small">Reset</button>
	<button type="button" class="button blue small" onclick='submitAction("${portletNamespace}UpdateExceptionalDeduct", "${renderAction}")'>Cancel</button>
</form:form>
