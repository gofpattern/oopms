...
<script type="text/javascript">
	...
	  });
	  $( "#datepicker1" ).datepicker({
	        ...
	        yav.init('${portletNamespace}UpdateDeliverable', rules);
	});
	...
	document.getElementById('note').innerHTML = "${UpdateDeliverableForm.note}";
...
<portlet:actionURL var="formAction">
  <portlet:param name="action" value="UpdateDeliverable" />
</portlet:actionURL>
...
<form:form name="${portletNamespace}UpdateDeliverable" commandName="UpdateDeliverableForm" method="post" action="${formAction}"> 
<table class="portlet-table">
      <tr>      
   		<th scope="row">Deliverable</th>
    	<td>${UpdateDeliverableForm.delivarableName}</td>
  	  </tr>
  	  <tr>
	...
	<button type="button" class="button blue small" onclick='submitAction2("${portletNamespace}UpdateDeliverable", "${formAction}")'>Update</button>
	<button type="reset" class="button blue small">Reset</button>
	<button type="button" class="button blue small" onclick='submitAction("${portletNamespace}UpdateDeliverable", "${renderAction}")'>Cancel</button>		
</form:form>
