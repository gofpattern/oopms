...
<title>Create Exceptional Deduct</title>	
</head>
...
<div  class="container"><%@ include file="/WEB-INF/jsp/Menu.jsp" %>
  ...
  <!-- begin .navigator -->
   ...
   <div class="fl-widget-titlebar titlebar portlet-titlebar">
    	<br><p class="title" id="headerDuyND">Create Exceptional Deduct</p>
    </div>


	<portlet:actionURL var="formAction">
  		<portlet:param name="action" value="CreateExceptionalDeduct" />
...
<form:form name="${portletNamespace}CreateExceptionalDeduct" commandName="CreateExceptionalDeductForm" method="post" action="${formAction}">
