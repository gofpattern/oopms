...
<SCRIPT type="text/javascript">
	...
	rules[7] = 'date|mask|mydate';		
	yav.addMask('mydate', '  /  /    ', '1234567890');

</SCRIPT>
<title>Create One Time Expense</title>	
</head>
...
<div  class="container"><%@ include file="/WEB-INF/jsp/Menu.jsp" %>
  ...
  <!-- begin .navigator -->
   ...
   <div class="fl-widget-titlebar titlebar portlet-titlebar">
    	<br><p class="title" id="headerDuyND">Create One Time Expense</p>
    </div>


	<portlet:actionURL var="formAction">
  		<portlet:param name="action" value="CreateOneTimeExpense" />
...
<form:form name="${portletNamespace}CreateOneTimeExpense" commandName="CreateOneTimeExpenseForm" method="post" action="${formAction}">
