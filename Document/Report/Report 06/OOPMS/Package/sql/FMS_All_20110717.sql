/*
 * Probleam: the ampersand special character
 * Replace & by and
 * Author: Open-Ones Group
*/
...
-- refer from Insight coding WorkProduct.getModuleListSchedule(), Schedule.getStageList()
   ...
   IS
      CURSOR c_defect
      IS
         SELECT p.project_id, p.code, p.customer, DECODE (p.category, 0, 'Development', 1, 'Maintenance', 2, 'Others') as project_category, pl.domain, DECODE (pl.application_type, 6, 'Back-end', 7, 'Business Management', 4, 'Develop GUIs', 10, 'E-Commercial and M-business', 15, 'Embedded Software', 9, 'Intelligent data and Information Retrieval', 14, 'Mainframe application', 8, 'Management information system', 11, 'Middle ware', 1, 'Normal application', 12, 'Other', 5, 'Unit Test', 2, 'Web application', 3, 'Web application and Web engineering') as application_type,
...
/
INSERT INTO APPLICATION_TYPE(APPLICATION_ID, TYPE_NAME, STATUS)
  VALUES(3, 'Web application and Web engineering', NULL)
/
INSERT INTO APPLICATION_TYPE(APPLICATION_ID, TYPE_NAME, STATUS)
...
/
INSERT INTO APPLICATION_TYPE(APPLICATION_ID, TYPE_NAME, STATUS)
  VALUES(9, 'Intelligent data and Information Retrieval', NULL)
/
INSERT INTO APPLICATION_TYPE(APPLICATION_ID, TYPE_NAME, STATUS)
  VALUES(10, 'E-Commercial and M-business', '0')
/
INSERT INTO APPLICATION_TYPE(APPLICATION_ID, TYPE_NAME, STATUS)
...
/
INSERT INTO BUSINESS_DOMAIN(DOMAIN_ID, DOMAIN_NAME, STATUS)
  VALUES(6, 'Government and Public Service', NULL)
/
INSERT INTO BUSINESS_DOMAIN(DOMAIN_ID, DOMAIN_NAME, STATUS)
...
/
INSERT INTO DEFECT_TYPE(DT_ID, NAME)
  VALUES(7, '07-Data and Database integrity')
/
INSERT INTO DEFECT_TYPE(DT_ID, NAME)
  VALUES(8, '08-Security and Access Control')
/
INSERT INTO DEFECT_TYPE(DT_ID, NAME)
...
/
INSERT INTO STAGE(STAGE_ID, NAME)
  VALUES(13, 'InitiationandDefinition')
/
INSERT INTO STAGE(STAGE_ID, NAME)
  VALUES(14, 'SolutionandConstruction')
/
INSERT INTO STAGE(STAGE_ID, NAME)
  VALUES(15, 'DefinitionandSolution')
/
...
/
INSERT INTO TAILORING(TAIL_ID, TAIL_PER, APP_CRI, PROCESS_ID, STATUS, CATEGORY)
  VALUES(98, 'QandA list is developed and maintained for recording all questions and answers exchange between project team and customer.', 'it is helpful for requirement undestanding, tracking.', 2, '1', '3')
/
INSERT INTO TAILORING(TAIL_ID, TAIL_PER, APP_CRI, PROCESS_ID, STATUS, CATEGORY)
...
/
INSERT INTO TAILORING(TAIL_ID, TAIL_PER, APP_CRI, PROCESS_ID, STATUS, CATEGORY)
  VALUES(109, 'Report customer status of bug and change using B and P voucher templated supplied by customer when release the product', 'Customer required', 7, '1', '3')
/
INSERT INTO TAILORING(TAIL_ID, TAIL_PER, APP_CRI, PROCESS_ID, STATUS, CATEGORY)
...
/
INSERT INTO METRIC_DES(METRIC_ID, METRIC_NAME, UNIT, DISPLAY_INDEX, HOT_PRIORITY, COLOR_TYPE, MGROUP_ID, METRIC_DESC, ID)
  VALUES('10.3      ', 'CandP Time', 'Day', 100300, NULL, '2', 10, 'To provide the measurement of supporting ability', 66)
/
INSERT INTO METRIC_DES(METRIC_ID, METRIC_NAME, UNIT, DISPLAY_INDEX, HOT_PRIORITY, COLOR_TYPE, MGROUP_ID, METRIC_DESC, ID)
...
/
INSERT INTO METRIC_DES(METRIC_ID, METRIC_NAME, UNIT, DISPLAY_INDEX, HOT_PRIORITY, COLOR_TYPE, MGROUP_ID, METRIC_DESC, ID)
  VALUES('5.8       ', 'Overdue NCsandObs', '#', NULL, 3, '1', 5, NULL, 420)
/
INSERT INTO METRIC_DES(METRIC_ID, METRIC_NAME, UNIT, DISPLAY_INDEX, HOT_PRIORITY, COLOR_TYPE, MGROUP_ID, METRIC_DESC, ID)
